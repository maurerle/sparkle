...
try:
    from sparkle.reinforcement_learning.learning_unit_operator import RLUnitsOperator
except ImportError:
    # to suffice the type hint as best as possible
    from sparkle.common.units_operator import UnitsOperator as RLUnitsOperator
